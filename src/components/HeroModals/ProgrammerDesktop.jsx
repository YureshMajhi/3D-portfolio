...
Command: npx gltfjsx@6.5.3 .\programmer_desktop_3d_pc.glb 
...
export function ProgrammerDesktop(props) {
  ...
  const monitorDisplay = useTexture("/images/monitor-display.png");
  const displayMaterial = new THREE.MeshBasicMaterial({ map: monitorDisplay });
  return (
